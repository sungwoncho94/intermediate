...
# 가장 끝에 있는 arr[r]을 pivot으로 삼아서
# pivot 보다 큰 수가 나오면 오른쪽으로 밀고, pivot보다 작은 수를 왼쪽에 위치시킴
# --> 왼쪽으로 이동한 숫자들의 다음값 (pivot보다 큰 값)을 pivot과 바꿔주면
# pivot 보다 작은값 | pivot | pivot 보다 큰 값 이 오게됨
